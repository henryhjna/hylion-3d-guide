...
export const COMPONENTS = {
  ...
  b_g431b_esc1: {
    ...
    specs: {
      mcu: 'STM32G431CB (ARM Cortex-M4F @ 170 MHz, FOC 연산)',
      gate_driver: 'L6387ED (BHL 공식 명시, 하프브리지 게이트드라이버)',
      power_mosfet: 'STL180N6F7 ×6 (3 phase × 2 = MOSFET 3쌍, BHL 공식)',
      current_sensing: '3-shunt 레지스터 (3상 전류 실시간 측정, FOC 정밀도용)',
      can_transceiver: '온보드 내장 (별도 트랜시버 불필요)',
      encoder_interface: 'I2C (AS5600 자기 엔코더 직결)',
      programmer: 'ST-LINK 도터보드 내장',
  ...
  as5600_encoder: {
    ...
    specs: {
      ...
      voltage: '3.3~5V',
      mount: 'BLDC 모터 축 끝단',
      magnet_type: '⚠️ 엔코더 동봉 자석만 사용 (반경 방향/radial 자화). 일반 축방향 자석은 작동 안 함',
