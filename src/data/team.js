...
export const TEAM = {
  ...
  delta2: {
    ...
    responsibilities: [
      'W-6~W-5: 인혁·희승과 상체 HW 조립 (토르소·mouth·SO-ARM) — 3인 병렬',
      'W-4~: BHL 다리 조립 + NUC↔CAN + 전원 + 비상정지 복귀',
      '낙상 감지 IM10A 벤치 (USB 직결)',
      '비상 매뉴얼 작성',
    ],
    currentFocus: 'W-6: 인혁·희승과 토르소 조립 동시 진행',
  },
  delta3: {
    id: 'delta3',
    name: '희승',
    role: 'AI 인프라 오너 — BHL 훈련 전담 + W-6/W-5 HW 합류',
    trackLead: 'Track B 리드',
    color: '#c8ff00',
    colorBright: '#e0ff66',
    parts: ['left_leg', 'right_leg', 'torso'],
    responsibilities: [
      'BHL Walking RL 학습 (HOVER reward, AMASS retargeting) — 야간 오토 학습',
      'IsaacLab 환경 + DR 튜닝',
      'W-6~W-5: 인혁·승민과 상체 HW 합류 (토르소, SO-ARM 조립) — 낮 슬롯',
      'W-5: 기어박스 후가공 + ESC 펌웨어 플래싱 선제 작업',
      'W-4: BHL 다리 조립 리드 + 공중지그 보행',
      'W-3~: 실체 mass 재학습 + sim2real 보정',
    ],
    currentFocus: 'W-6: RL 학습(오토) + 토르소 조립 참여',
  },
  epsilon1: {
    id: 'epsilon1',
    name: '성래',
