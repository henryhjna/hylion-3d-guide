...
export const HANDOFFS = {
  ...
  "w5_scenario_bc_design -> w7_survival_scenario_final": {
    ...
    verification: "epsilon1이 상태 머신에 시나리오 B/C 전환 로직을 구현하여 테스트 통과",
    from: "delta3",
    to: "epsilon1",
  },
  ...
  "w5_smolvla_best_combo -> w7_smolvla_v2_data": {
    ...
    verification: "epsilon1이 TensorRT 변환 성공 + Orin에서 추론 실행 + 정합성 검증",
    from: "delta3",
    to: "epsilon1",
  },
  "w7_smolvla_v2_dgx -> w7_smolvla_v2_data": {
    ...
    deadline: "Week 7 중반",
    verification: "epsilon1이 TensorRT v2 변환 + Orin 배포 + 실물 pick 테스트 통과",
    from: "delta3",
    to: "epsilon1",
  },
